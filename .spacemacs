...
you should place your code here."
  ...
  ;; define org mode config hook
  (defun my-org-mode-config ()
    "For use in `org-mode-hook'."
    (local-set-key (kbd "S-<return> ") 'org-insert-item) ;  remove a key
    (local-set-key (kbd "M-<return> ") 'org-insert-item) ;  remove ba key
    )
  ;; add to hook
 ...
 '(org-capture-templates
   (quote
    (("j" "journal entry" entry
      (file+weektree "~/Dropbox/org/notes.org")
      "")
     ("t" "TODO entry" entry
